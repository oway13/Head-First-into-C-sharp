...
namespace StarbuzzCh15
{
	...
	public partial class People : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _Client_;
    ...
    partial void OnClient_Changing(System.Nullable<bool> value);
    partial void OnClient_Changed();
    ...
    partial void OnLastCallChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="Client?", Storage="_Client_", DbType="Bit")]
		public System.Nullable<bool> Client_
		{
			get
			{
			...
			set
			{
				if ((this._Client_ != value))
				{
					this.OnClient_Changing(value);
					this.SendPropertyChanging();
					this._Client_ = value;
					this.SendPropertyChanged("Client_");
					this.OnClient_Changed();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="Last Call", Storage="_LastCall", DbType="DateTime")]
